...
public class SecondActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        objQuitButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(SecondActivity.this).setTitle(R.string.quitBtn)
    ...
    class FetchDataTask extends AsyncTask<List<Object>, Integer, String> {
        ...
        protected String doInBackground(List<Object>... lstParams) {
            ...
            try {
                ...
                if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                    Log.d(TAG, "queryList()  请求成功:" + strRequestUrl + "参数:" + strParam);
                    // 取得返回的字符串
                    String strResult = EntityUtils.toString(httpResponse.getEntity());
                    if (strResult.length() == 0) {
                        Log.d(TAG, "queryList()  请求失败:" + strRequestUrl + "参数:" + strParam);
                    ...
                    Log.d(TAG, "doLogin()  请求失败:" + strRequestUrl + "参数:" + strParam);
        ...
        protected void onPostExecute(String result) {
            ...
            // 自定义的适配器
            adapter = new MyAdapter(SecondActivity.this, listData, R.layout.item);
            // 实现列表的显示
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            new AlertDialog.Builder(SecondActivity.this).setTitle(R.string.backBtn)

...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	// 日志的路径
	private final String logPath = Environment.getExternalStorageDirectory()
			.getPath() + "/Hekangping/Crash/";
